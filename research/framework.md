...
用户表达目标与约束，多个Agent解释要求并推进任务，持续输出计划、工具结果、进度、变化和征询等信息；空间交互界面聚合、归因并组织这些输出，关联空间对象，支持理解、参与及结果确认。设备群自主执行和接替是应用背景，也带来多源输出聚合与空间关联的交互问题。
...
| --- | --- | --- | --- |
| M1 执行信息组织与呈现 | 现在怎样、发生了什么、与任务有什么关系？ | 多个Agent的目标解释/计划/工具结果/进度/变化 → 可理解的任务过程 | 多源输出的聚合、归因与冲突呈现，按任务组织，突出重点与待处理事项，摘要/详情分层，地图与任务相互定位 |
